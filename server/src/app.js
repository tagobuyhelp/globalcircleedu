...
// CORS configuration
const allowedOrigins = ['http://localhost:4000', 'https://globalcircleedu.tagobuy.site', 'https://www.tagobuy.net', 'https://globalcircleedu.netlify.app', 'http://localhost:5173'];
