...
const teamMembers = [
  {
    ...
    description: 'With over 15 years of experience in international education consulting, Dr. Johnson leads our academic counseling team.',
    linkedin: '#',
    email: 'sarah@globalcircleedu.com',
    icon: GraduationCap,
    color: 'blue'
  },
  {
    name: 'Michael Chen',
    role: 'Career Development Head',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80',
    expertise: 'Career Counseling',
    description: 'A certified career counselor with extensive experience in global job markets and placement services.',
    linkedin: '#',
    email: 'michael@globalcircleedu.com',
    icon: Briefcase,
    color: 'orange'
  },
  {
    ...
    expertise: 'Visa & Immigration',
    description: 'Specializes in student visas and immigration procedures for major study destinations worldwide.',
    linkedin: '#',
    email: 'emma@globalcircleedu.com',
    icon: Globe,
    color: 'green'
  },
  {
    ...
    expertise: 'Student Mentoring',
    description: 'Dedicated to ensuring student success through personalized mentoring and support programs.',
    linkedin: '#',
    email: 'david@globalcircleedu.com',
    icon: Users,
    color: 'purple'
  }
];
